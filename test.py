...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="E:/biyesheji/code3/pytorch-auto-drive/configs/lane_detection/bezierlanenet/beziertest.py",
                        type=str, help='Path to config file')
    parser.add_argument('--image-path', default="./testimgs", type=str,
                        help='Image input path')

    parser.add_argument('--save-path', default="./resultimg", type=str,
